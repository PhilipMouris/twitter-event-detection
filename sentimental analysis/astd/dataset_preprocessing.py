...
with open("train_tweets.json", encoding="utf8") as json_file:
    train_tweets = json.load(json_file)

with open("test_tweets.json", encoding="utf8") as json_file:
    test_tweets = json.load(json_file)
...
with open("train_tweets_preprocessed.json", "w", encoding="utf8") as outfile:
    json.dump(train_tweets, outfile, indent=4, ensure_ascii=False)

with open("test_tweets_preprocessed.json", "w", encoding="utf8") as outfile:
    json.dump(test_tweets, outfile, indent=4, ensure_ascii=False)
